...
class JadwalController extends Controller
{
    public function index()
    {
        ...
        return view('kurikulum.jadwal.index', $data);
    }
    ...
    public function guru($nig)
    {
        ...
        return view('kurikulum.jadwal.guru', $data);
    }
    ...
    public function view_table($nig, $id_kelas)
    {
        ...
        return view('kurikulum.jadwal.table', $data);
    }
    ...
    public function edit($nig, $id_kelas, $id_jadwal)
    {
        ...
        return view('kurikulum.jadwal.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kurikulum.jadwal.two', ['nig' => $jadwal->guru->nig, 'id_kelas' => $jadwal->id_kelas])->with('success', 'Jadwal berhasil diupdate!');
    }
