@extends('template.template-walikelas')
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.walikelas') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('walikelas.riwayatkelas') }}">Pilih Kelas</a></li>
...
<div class="modal fade text-left" id="naik_tingkat" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('walikelas.riwayatkelas.updatekelas', request()->segment(3)) }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <tr>
                                ...
                                <div class="btn-group dropend me-1 mb-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <form action="{{ route('walikelas.riwayatkelas.updateStatus', $sa->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
